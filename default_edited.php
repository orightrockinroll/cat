...
<script>
	...
	/*function gotoPage(){
		...
		<?php
			$_SESSION['page_no'] = $_GET(pageNum);
		?>
		
		window.location.href = 'default.php?nav=pageinput&emode=0';
	}*/
</script>
       ...
       right: 0;">
		...
		<!--<div style="position:relative;width:1200px;height:30px;
		   ...
		   right: 0; text-align: center;">
			Input a page number:
			<input id="pageNumber" type="number" style="width:60px;" min="1" max="<?php echo $pageCount_ ?>"/>
		</div>-->
