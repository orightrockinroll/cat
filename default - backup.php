	...
	<script type='text/javascript' src="./js/fullmode.js"></script>
		...
		<script>
			...
			function gotoPage(){
				...
				alert('default.php?nav=gotopage&pageNumber=' + pageNum + '&emode=0');
				//alert(window.location);
				//alert(window.location.pathname);
				window.location.href = 'default.php?nav=&pageNumber=' + pageNum + '&emode=0';
				//window.location'default.php?nav=first&pageNumber=' + pageNum + '&emode=0');
			}
		</script>
		...
		//echo $nav . "<br/>";
		   ...
		   if($nav == 'right' && $isEdit == 0){
			...
			if($nav == "" && $editMode == 0 && isset($_GET["pageNumber"])){
			   echo "page number:" . $_GET["pageNumber"];
 ...
 <form id="frmEditor" name="frmEditor" action="write_xml_pages.php" method="post" onsubmit="getDivCoords();" enctype="multipart/form-data">
	...
	<div id="divContainer" style="position:absolute;width:1220px;height:800px;margin-left: auto;
       ...
       right: 0;">
		...
		<div style="position:relative;width:1200px;height:30px;
		   margin-left: auto;
		   margin-right: auto;
		   left: 0;
		   right: 0; text-align: center;">
			Input a page number:
			<input id="pageNumber" type="text" style="width:60px;" min="1" max="<?php echo $pageCount_ ?>" />
			<input name="bntGo" type="submit" id="btnGo" value="Go" title="Go" onclick="gotoPage()"/>
		</div>
		...
		<div style="float:right;position: relative;width: 600px;" onclick="getXyLocation(event);" >
			...
			<div id="nav_right" style="position:relative; float: right;top:-420px;z-index:2020" ondrop="drop(event, 'left', '<?php echo $isDraggable; ?>')" ondragover="allowDrop(event)"> <!-- left:60px; -->
